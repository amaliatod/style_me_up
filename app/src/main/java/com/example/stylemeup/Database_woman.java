...
public class Database_woman extends SQLiteOpenHelper {
    ...
    private static final String TABLE_DRESSES = "DRESSES";
    ...
    public Database_woman(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createDressesTable = "CREATE TABLE " + TABLE_DRESSES + "(" +
                COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                COLUMN_IMAGE_URL + " TEXT," +
                COLUMN_DOMINANT_COLOR + " TEXT," +
                COLUMN_STYLE + " TEXT)";
        db.execSQL(createDressesTable);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_DRESSES);
    ...
    public void insertInWomenDb(String category, String imageUrl, String dominantColor, String style) {
        ...
        if (category.equals("dresses")) {
            db.insert(TABLE_DRESSES, null, values);
        }
    ...
    public void deleteDatabase() {
        ...
        db.delete(TABLE_DRESSES, null, null);
